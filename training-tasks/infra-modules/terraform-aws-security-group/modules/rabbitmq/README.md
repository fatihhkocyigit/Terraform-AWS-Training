...
module "rabbitmq_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/rabbitmq"

  # omitted...
}
```

All automatic values **rabbitmq module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/rabbitmq/auto_values.tf).
