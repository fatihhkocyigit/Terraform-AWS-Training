...
module "openvpn_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/openvpn"

  # omitted...
}
```

All automatic values **openvpn module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/openvpn/auto_values.tf).
