...
module "graphite_statsd_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/graphite-statsd"

  # omitted...
}
```

All automatic values **graphite-statsd module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/graphite-statsd/auto_values.tf).
