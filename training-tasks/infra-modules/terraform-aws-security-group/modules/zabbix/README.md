...
module "zabbix_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/zabbix"

  # omitted...
}
```

All automatic values **zabbix module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/zabbix/auto_values.tf).
