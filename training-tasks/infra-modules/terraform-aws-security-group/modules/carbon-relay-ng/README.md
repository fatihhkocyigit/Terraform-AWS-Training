...
module "carbon_relay-ng_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/carbon-relay-ng"

  # omitted...
}
```

All automatic values **carbon-relay-ng module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/carbon-relay-ng/auto_values.tf).
