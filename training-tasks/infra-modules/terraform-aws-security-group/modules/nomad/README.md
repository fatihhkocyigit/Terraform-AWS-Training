...
module "nomad_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/nomad"

  # omitted...
}
```

All automatic values **nomad module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/nomad/auto_values.tf).
