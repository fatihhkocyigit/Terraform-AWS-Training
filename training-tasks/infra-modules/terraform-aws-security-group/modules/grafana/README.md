...
module "grafana_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/grafana"

  # omitted...
}
```

All automatic values **grafana module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/grafana/auto_values.tf).
