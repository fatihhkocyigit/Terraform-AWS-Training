...
module "ipsec_500_security_group" {
  source  = "terraform-aws-security-group/modules/ipsec-500"

  # omitted...
}
```

All automatic values **ipsec-500 module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/ipsec-500/auto_values.tf).
