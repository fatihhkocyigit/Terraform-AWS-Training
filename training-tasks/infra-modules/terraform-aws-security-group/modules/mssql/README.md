...
module "mssql_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/mssql"

  # omitted...
}
```

All automatic values **mssql module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/mssql/auto_values.tf).
