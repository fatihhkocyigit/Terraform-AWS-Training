...
module "web_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/web"

  # omitted...
}
```

All automatic values **web module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/web/auto_values.tf).
