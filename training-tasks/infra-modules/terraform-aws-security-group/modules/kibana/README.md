...
module "kibana_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/kibana"

  # omitted...
}
```

All automatic values **kibana module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/kibana/auto_values.tf).
