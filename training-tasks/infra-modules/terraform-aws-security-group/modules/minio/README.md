...
module "minio_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/minio"

  # omitted...
}
```

All automatic values **minio module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/minio/auto_values.tf).
