...
module "smtps_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/smtps"

  # omitted...
}
```

All automatic values **smtps module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/smtps/auto_values.tf).
