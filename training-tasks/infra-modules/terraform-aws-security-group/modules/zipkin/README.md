...
module "zipkin_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/zipkin"

  # omitted...
}
```

All automatic values **zipkin module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/zipkin/auto_values.tf).
