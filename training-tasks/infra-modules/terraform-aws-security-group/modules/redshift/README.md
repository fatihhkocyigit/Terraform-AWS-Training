...
module "redshift_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/redshift"

  # omitted...
}
```

All automatic values **redshift module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/redshift/auto_values.tf).
