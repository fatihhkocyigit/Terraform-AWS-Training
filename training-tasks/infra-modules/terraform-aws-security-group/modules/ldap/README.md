...
module "ldap_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/ldap"

  # omitted...
}
```

All automatic values **ldap module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/ldap/auto_values.tf).
