...
module "mongodb_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/mongodb"

  # omitted...
}
```

All automatic values **mongodb module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/mongodb/auto_values.tf).
