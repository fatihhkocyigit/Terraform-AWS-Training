...
module "kubernetes_api_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/kubernetes-api"

  # omitted...
}
```

All automatic values **kubernetes-api module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/kubernetes-api/auto_values.tf).
