...
module "http_80_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/http-80"

  # omitted...
}
```

All automatic values **http-80 module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/http-80/auto_values.tf).
