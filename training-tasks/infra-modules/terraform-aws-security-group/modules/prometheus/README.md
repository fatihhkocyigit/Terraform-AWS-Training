...
module "prometheus_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/prometheus"

  # omitted...
}
```

All automatic values **prometheus module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/prometheus/auto_values.tf).
