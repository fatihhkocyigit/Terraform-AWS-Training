...
module "smtp_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/smtp"

  # omitted...
}
```

All automatic values **smtp module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/smtp/auto_values.tf).
