...
module "http_8080_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/http-8080"

  # omitted...
}
```

All automatic values **http-8080 module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/http-8080/auto_values.tf).
