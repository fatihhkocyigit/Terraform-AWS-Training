...
module "redis_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/redis"

  # omitted...
}
```

All automatic values **redis module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/redis/auto_values.tf).
