...
module "docker_swarm_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/docker-swarm"

  # omitted...
}
```

All automatic values **docker-swarm module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/docker-swarm/auto_values.tf).
