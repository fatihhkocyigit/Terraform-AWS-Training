...
module "logstash_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/logstash"

  # omitted...
}
```

All automatic values **logstash module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/logstash/auto_values.tf).
