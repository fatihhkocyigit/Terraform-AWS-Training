...
module "etcd_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/etcd"

  # omitted...
}
```

All automatic values **etcd module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/etcd/auto_values.tf).
