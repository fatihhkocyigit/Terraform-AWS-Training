...
module "winrm_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/winrm"

  # omitted...
}
```

All automatic values **winrm module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/winrm/auto_values.tf).
