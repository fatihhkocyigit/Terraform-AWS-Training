...
module "postgresql_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/postgresql"

  # omitted...
}
```

All automatic values **postgresql module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/postgresql/auto_values.tf).
