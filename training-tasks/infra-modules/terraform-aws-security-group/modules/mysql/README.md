...
module "mysql_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/mysql"

  # omitted...
}
```

All automatic values **mysql module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/mysql/auto_values.tf).
