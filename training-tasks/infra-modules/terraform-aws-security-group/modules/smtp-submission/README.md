...
module "smtp_submission_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/smtp-submission"

  # omitted...
}
```

All automatic values **smtp-submission module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/smtp-submission/auto_values.tf).
