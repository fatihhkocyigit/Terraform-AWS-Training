...
module "activemq_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/activemq"

  # omitted...
}
```

All automatic values **activemq module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/activemq/auto_values.tf).
