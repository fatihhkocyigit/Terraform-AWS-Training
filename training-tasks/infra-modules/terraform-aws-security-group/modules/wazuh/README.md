...
module "wazuh_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/wazuh"

  # omitted...
}
```

All automatic values **wazuh module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/wazuh/auto_values.tf).
