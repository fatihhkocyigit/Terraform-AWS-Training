...
module "ntp_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/ntp"

  # omitted...
}
```

All automatic values **ntp module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/ntp/auto_values.tf).
