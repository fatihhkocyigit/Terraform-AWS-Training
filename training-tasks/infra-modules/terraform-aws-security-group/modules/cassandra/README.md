...
module "cassandra_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/cassandra"

  # omitted...
}
```

All automatic values **cassandra module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/cassandra/auto_values.tf).
