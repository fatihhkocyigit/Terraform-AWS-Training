...
module "kafka_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/kafka"

  # omitted...
}
```

All automatic values **kafka module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/kafka/auto_values.tf).
