...
module "storm_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/storm"

  # omitted...
}
```

All automatic values **storm module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/storm/auto_values.tf).
