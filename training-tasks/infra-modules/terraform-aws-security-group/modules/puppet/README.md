...
module "puppet_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/puppet"

  # omitted...
}
```

All automatic values **puppet module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/puppet/auto_values.tf).
