...
module "consul_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/consul"
  
  # omitted...
}
```

All automatic values **consul module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/consul/auto_values.tf).
