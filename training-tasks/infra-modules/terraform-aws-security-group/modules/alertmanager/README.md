...
module "alertmanager_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/alertmanager"

  # omitted...
}
```

All automatic values **alertmanager module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/alertmanager/auto_values.tf).
