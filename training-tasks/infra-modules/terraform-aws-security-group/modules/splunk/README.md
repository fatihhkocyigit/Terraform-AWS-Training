...
module "splunk_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/splunk"

  # omitted...
}
```

All automatic values **splunk module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/splunk/auto_values.tf).
