...
module "squid_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/squid"

  # omitted...
}
```

All automatic values **squid module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/squid/auto_values.tf).
