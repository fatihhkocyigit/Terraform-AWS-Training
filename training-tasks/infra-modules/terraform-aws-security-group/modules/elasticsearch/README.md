...
module "elasticsearch_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/elasticsearch"

  # omitted...
}
```

All automatic values **elasticsearch module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/elasticsearch/auto_values.tf).
