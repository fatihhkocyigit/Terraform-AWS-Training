...
module "memcached_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/memcached"

  # omitted...
}
```

All automatic values **memcached module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/memcached/auto_values.tf).
