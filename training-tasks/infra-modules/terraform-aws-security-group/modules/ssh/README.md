...
module "ssh_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/ssh"

  # omitted...
}
```

All automatic values **ssh module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/ssh/auto_values.tf).
