...
module "rdp_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/rdp"

  # omitted...
}
```

All automatic values **rdp module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/rdp/auto_values.tf).
