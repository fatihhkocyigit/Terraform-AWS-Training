...
module "oracle_db_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/oracle-db"

  # omitted...
}
```

All automatic values **oracle-db module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/oracle-db/auto_values.tf).
