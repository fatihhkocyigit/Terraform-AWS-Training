...
module "ldaps_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/ldaps"

  # omitted...
}
```

All automatic values **ldaps module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/ldaps/auto_values.tf).
