...
module "solr_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/solr"

  # omitted...
}
```

All automatic values **solr module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/solr/auto_values.tf).
