...
module "nfs_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/nfs"

  # omitted...
}
```

All automatic values **nfs module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/nfs/auto_values.tf).
