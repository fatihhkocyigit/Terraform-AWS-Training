...
module "https_443_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/https-443"

  # omitted...
}
```

All automatic values **https-443 module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/https-443/auto_values.tf).
