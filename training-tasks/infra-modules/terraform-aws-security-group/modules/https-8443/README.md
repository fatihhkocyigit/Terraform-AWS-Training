...
module "https_8443_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/https-8443"

  # omitted...
}
```

All automatic values **https-8443 module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/https-8443/auto_values.tf).
