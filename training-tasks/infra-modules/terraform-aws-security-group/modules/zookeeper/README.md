...
module "zookeeper_security_group" {
  source  = "inf.modules/terraform-aws-security-group/modules/zookeeper"

  # omitted...
}
```

All automatic values **zookeeper module** is using are available [here](https://github.com/trtworld/inf.modules/tree/main/terraform-aws-security-group/modules/zookeeper/auto_values.tf).
